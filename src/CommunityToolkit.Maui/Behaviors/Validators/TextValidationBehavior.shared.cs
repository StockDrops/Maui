...
/// <summary>Flags to indicate what treatment <see cref="BaseValidationBehavior.Value"/> should receive prior to validation with <see cref="ValidationBehavior"/> or subclasses. This can be used to trim or ignore whitespace for instance. This value might be ignored by a behavior if <see cref="BaseValidationBehavior.Value"/> isn't of type <see cref="string"/>.</summary>
[Flags]
public enum TextDecorationFlags
{
	...
	/// <summary>If <see cref="BaseValidationBehavior.Value"/> is null, replace the value with <see cref="string.Empty"/></summary>
	NullToEmpty = 4,
	/// <summary>Excessive white space is removed from <see cref="BaseValidationBehavior.Value"/> prior to validation. I.e. I.e. "Hello    World" will become "Hello World". This applies to whitespace found anywhere.</summary>
